...
public final class CurrencyFormatUtil {
	...
	public static String royaltyWithDecimal(Double royalty) {
		DecimalFormat formatter = new DecimalFormat("###,###,###.00");
		return formatter.format(royalty);
	}

	public static String royaltyWithoutDecimal(Double royalty) {
		DecimalFormat formatter = new DecimalFormat("###,###,###.##");
		return formatter.format(royalty);
	}

	public static String royaltyToString(Double royalty) {
		String toShow = royaltyWithoutDecimal(royalty);
		if (toShow.indexOf(".") > 0) {
			return royaltyWithDecimal(royalty);
		}
		return royaltyWithoutDecimal(royalty);
	}
